...
if (!fs.existsSync(sourceDir)) {
  console.error("");
  console.error("ERROR: uGMRT source directory not found:");
...
report +=
  "DIYA ASTRA - uGMRT USER SOURCE ASSET AUDIT\n";
...
report +=
  "uGMRT USER SOURCE AUDIT COMPLETE\n";
...
console.log(
  "DIYA ASTRA - uGMRT SOURCE AUDIT COMPLETE"
);
