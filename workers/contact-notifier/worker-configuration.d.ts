/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers\contact-notifier\wrangler.jsonc workers\contact-notifier\worker-configuration.d.ts` (hash: 4f7811190c9f9981afa82a88e0d4861b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GMAIL_CLIENT_ID" | "GMAIL_CLIENT_SECRET" | "GMAIL_REFRESH_TOKEN">> {}
}
