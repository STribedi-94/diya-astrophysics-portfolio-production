/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/contact/wrangler.jsonc workers/contact/worker-configuration.d.ts` (hash: 3662846390514682a0f20e6f61c1e3f8)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 
interface __BaseEnv_Env {
	CONTACT_DB: D1Database;
	CONTACT_NOTIFICATION_QUEUE: Queue;
	CONTACT_RATE_LIMITER: RateLimit;
	TURNSTILE_HOSTNAME: "astro-diya.mdwarfs.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_HOSTNAME" | "TURNSTILE_SECRET_KEY">> {}
}
