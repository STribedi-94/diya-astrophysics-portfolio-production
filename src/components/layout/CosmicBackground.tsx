...
export function CosmicBackground() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 starfield opacity-70 anim-drift" />
      ...
      {/* Nebula blooms */}
      <div
        className="absolute -left-40 top-1/4 h-[560px] w-[560px] rounded-full opacity-40 blur-3xl anim-pulse-slow"
        style={{
          background:
      ...
      />
      <div
        className="absolute -right-40 top-1/2 h-[520px] w-[520px] rounded-full opacity-35 blur-3xl anim-pulse-slow"
        style={{
          animationDelay: "1.5s",
          background:
